...
Fine-tuned on a custom food dataset
...
best_model.pt → Trained classification model

mobilenet_final.ipynb → Model training and experimentation notebook

# How It Works

Input food images into the system

Model classifies food condition
...
Insights to support waste reduction strategies
...
Extend to multiple food categories
